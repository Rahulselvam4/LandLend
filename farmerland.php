 ...
 <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5" id="home">
     ...
     <div class="products">
         <div class="box-container">
             ...
             <?php
                    $select = mysqli_query($conn, "select * from productsfarmer");
    ...
    <input type="hidden" name="years" value="<?php echo $row['years'];
     ...
     <button type="submit"  style="width: 150px; background-color:orange; border-radius: 10px;"><b>Lease the land</b></button>
