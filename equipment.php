...
<div class="card opacity-100 " style="width: 28rem; margin-left: 500px; margin-top: 80px; margin-bottom:10px; background-color:rgba(255, 255, 255, 0.5);">
            ...
            <div class="card-body text-center ">
                <div class="form-group mb-3">
                    <input type="text" class="form-control" name="eqname" placeholder="the Equipment name">
                </div>
                <div class="form-group mb-3">
    ...
    if (isset($_POST['add'])) {
        ...
        $query = "INSERT INTO product(eqname,model,Location,Amount,description,document,user_id,Mobile) VALUES ('$eqname', '$model','$Location',
